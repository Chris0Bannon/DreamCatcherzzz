    ...
    render(){
        ...
        return (
          <div>
            ...
            <p>{JSON.stringify(this.props.reduxStore.mostRecentUserEntry.user_response)}</p>
            ...
            <Button onClick = {() => {this.props.history.push('/recentSubmissionReview')}} color = "secondary" variant = "contained">Nah GO Back</Button>
          </div>
        );
    }
